package com.farasatnovruzov.newsappjava.data;

import java.util.Date;

public class NewsItem {
//    https://newsapi.org/v2/everything?q=tesla&language=ru&from=2022-06-26&sortBy=publishedAt&apiKey=ea96fc26b3d14df8938fbb351e1200a3
...
//    tvPublishedAt.text = article.publishedAt
    ...
    String bgColor;
    Date dateCreation;
    int viewType = 0; //required to determine the viewtype for simple news type(text based news) 1 for image based news 2 for news that contains video..
    String videoUrl;
    boolean isFav = false;
